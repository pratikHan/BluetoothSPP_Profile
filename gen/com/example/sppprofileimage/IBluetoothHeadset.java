 ...
 * Original file: D:\\workspace17\\SppProfileImage\\src\\com\\example\\sppprofileimage\\IBluetoothHeadset.aidl
 */
package com.example.sppprofileimage;
public interface IBluetoothHeadset extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.sppprofileimage.IBluetoothHeadset
{
private static final java.lang.String DESCRIPTOR = "com.example.sppprofileimage.IBluetoothHeadset";
...
/**
 * Cast an IBinder object into an com.example.sppprofileimage.IBluetoothHeadset interface,
 * generating a proxy if needed.
 */
public static com.example.sppprofileimage.IBluetoothHeadset asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.sppprofileimage.IBluetoothHeadset))) {
return ((com.example.sppprofileimage.IBluetoothHeadset)iin);
}
return new com.example.sppprofileimage.IBluetoothHeadset.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.sppprofileimage.IBluetoothHeadset
{
...
@Override public boolean disconnectHeadset(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public int getState(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_connectHeadset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
...
static final int TRANSACTION_startVoiceRecognition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_stopVoiceRecognition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_isAudioConnected = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_sendVendorSpecificResultCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getBatteryUsageHint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_acceptIncomingConnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_rejectIncomingConnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getAudioState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_isAudioOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_connectAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_disconnectAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_startScoUsingVirtualVoiceCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_stopScoUsingVirtualVoiceCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_phoneStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_clccResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
}
// Public API
...
public boolean disconnectHeadset(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
